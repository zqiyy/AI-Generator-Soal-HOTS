...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buat soal HOTS otomatis dari materi PDF berbasis Taksonomi Bloom untuk Kurikulum Merdeka & K-13." },
      { name: "author", content: "UNESA Tim RPL" },
